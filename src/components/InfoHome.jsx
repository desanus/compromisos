    ...
    return (
        <Card className="info-home">
            ...
            <Card.Body>
                ...
                <h2>En nuestra visión de una gestión municipal abierta y transparente, reconocemos la importancia de mantener las puertas de nuestro gobierno abiertas a la comunidad. Creemos firmemente en la rendición de cuentas, la auditoría y el seguimiento constante de nuestras acciones como pilares fundamentales de una administración responsable.</h2>
                <h2>
